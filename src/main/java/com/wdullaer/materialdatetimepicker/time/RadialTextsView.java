...
public class RadialTextsView extends View {
    ...
    public void initialize(Context context, String[] texts, String[] innerTexts,
        ...
        // Set up the paint.
        int textColorRes = controller.isThemeDark() ? R.color.mdtp_accent_color : R.color.mdtp_accent_color;
        ...
        int inactiveColorRes = controller.isThemeDark() ? R.color.mdtp_accent_color
                : R.color.mdtp_date_picker_text_disabled;
//        int inactiveColorRes = controller.isThemeDark() ? R.color.mdtp_accent_color
//                : R.color.mdtp_accent_color;
        //mdtp_accent_color
